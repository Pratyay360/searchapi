...
def get_imdb_url_id(imdb_item_id: str) -> str | None:
    id_prefix = imdb_item_id[:2]
    return IMDB_PREFIX_TO_URL_ID.get(id_prefix)


def get_wikimedia_image_id(url: str) -> str:
...
def get_external_url(
    url_id: str, item_id: str | None, alternative: str = "default"
) -> str | None:
...
def get_earth_coordinates_url(
    latitude, longitude, osm_zoom, alternative: str = "default"
):
    url = (
