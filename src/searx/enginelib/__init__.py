...
__all__ = ["ENGINES_CACHE", "Engine", "EngineCache"]
...
from ..cache import ExpireCacheCfg, ExpireCacheSQLite
...
@app.command()
def maintenance(force: bool = True, truncate: bool = False) -> None:
...
class EngineCache:
    ...
    def __init__(self, engine_name: str, expire: int | None = None) -> None:
        ...
        self.table_name: str = "eng_" + "".join(
            [c if c in _valid else "_" for c in engine_name]
        )
