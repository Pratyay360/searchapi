...
- :py:obj:`.request` is replaced by :py:obj:`sxng_request`
- :py:obj:`.Request` is replaced by :py:obj:`SXNG_Request`
...
.. py:attribute:: sxng_request
   ...
   A replacement for :py:obj:`.request` with type cast :py:obj:`SXNG_Request`.
...
if typing.TYPE_CHECKING:
    ...
    from searx.search.processors import (
        OnlineParamTypes,
        OnlineDictParams,
