...
search_syntax = re.compile(r".*?([a-z]+)-([a-z]+) (.+)$", re.IGNORECASE)
"""Search syntax used for from/to language (e.g. ``en-de``)"""

type FromToType = tuple[bool, str, str]
...
class OnlineDictionaryProcessor(OnlineProcessor):
    ...
    def get_params(
        ...
        online_params: OnlineParams | None = super().get_params(
