...
class Search:
    ...
    def search_answerers(self) -> bool:
...
class SearchWithPlugins(Search):
    ...
    def __init__(
        ...
        # get the "real" request to use it outside the  context.
        # see
        # * https://github.com/pallets//blob/d01d26e5210e3ee4cbbdef12f05c886e08e92852/src//globals.py#L55
    ...
    def _on_result(self, result) -> bool:
