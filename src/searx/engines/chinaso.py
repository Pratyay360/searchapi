...
def init(_) -> None:
    ...
    if chinaso_category == "news" and chinaso_news_source not in t.get_args(
...
def request(query, params):
    ...
    category_config = {
        "news": {
            ...
            "params": {"pn": params["pageno"], "ps": results_per_page},
        },
        "images": {
    ...
    params["url"] = (
        f"{base_url}{category_config[chinaso_category]['endpoint']}?{urlencode(query_params)}"
    )
    cookie = {
