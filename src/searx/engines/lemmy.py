        ...
        results.append(
            {
                ...
                "thumbnail": result["community"].get(
                    "icon", result["community"].get("banner")
                ),
                "publishedDate": datetime.strptime(
                    counts["published"][:19], "%Y-%m-%dT%H:%M:%S"
                ),
                "metadata": metadata,
            }
        )
        ...
        results.append(
            {
                ...
                "thumbnail": thumbnail,
                "publishedDate": datetime.strptime(
                    result["post"]["published"][:19], "%Y-%m-%dT%H:%M:%S"
                ),
                "metadata": metadata,
            }
        )
        ...
        results.append(
            {
                ...
                "publishedDate": datetime.strptime(
                    result["comment"]["published"][:19], "%Y-%m-%dT%H:%M:%S"
                ),
                "metadata": metadata,
            }
        )
